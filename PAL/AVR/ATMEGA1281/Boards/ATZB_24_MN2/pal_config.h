...
#define TST_PORT_HIGH()							(TRX_PORT3 |= _BV(TST))
#define TST_PORT_LOW()							(TRX_PORT3 &= ~ _BV(TST))
...
/* Wait for 500 ns. */
#define PAL_WAIT_500_NS()               {nop(); nop(); nop(); nop(); nop(); nop(); nop(); nop();}
