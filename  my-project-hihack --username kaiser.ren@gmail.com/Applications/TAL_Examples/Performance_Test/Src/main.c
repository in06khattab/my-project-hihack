...
static uint8_t phy_frame_length = 127;
...
static bool csma_enabled = false;
...
#endif
	 /* An option for low power mode test  */
	 printf("(B) : Set into Low-Power mode \r\n");
...
#else
	 //08 00 ff ff bb 09    A..Z...;.....;.
//000f:   0a f2 08 01 01 00 01 00 01 e0 00 7b 38 07 ff    .r.......`.{8..
//001e:   ff 00 01 34 13 7d .. ..
	 *temp_frame_ptr++ = 0x08;
	 *temp_frame_ptr++ = 0;
	 *temp_frame_ptr++ = 0xff;
	 *temp_frame_ptr++ = 0xff;
	 *temp_frame_ptr++ = 0xd6;		//nwk addr lsb
	 *temp_frame_ptr++ = 0x09;    //nwk addr msb
	 *temp_frame_ptr++ = 0x0a;
	 *temp_frame_ptr++ = 0xf2;
	 *temp_frame_ptr++ = 0x08;
	 *temp_frame_ptr++ = 0x01;
