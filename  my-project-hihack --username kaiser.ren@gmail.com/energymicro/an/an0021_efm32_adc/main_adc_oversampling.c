/******************************************************************************
 * @file
 * @brief ADC oversampling example
...
/***************************************************************************//**
* @brief
*   Configure ADC usage for measuring vdd/3 with oversampling.
*******************************************************************************/
...
/******************************************************************************
 * @brief  Main function
 * The ADC is set up in single conversion mode with oversampling and samples VDD/3 10 times each
...
int main(void)
{
  ...
  while (1)
  {
    ...
    voltage = (sample * 1250 * 3) / 65536;

    /* Write to LCD */
    SegmentLCD_Number(voltage);

    /* wait 100ms in EM2 before next conversion.
     * The rtc interrupt handler is located in the efm32 rtc library; see em_rtc.c */
