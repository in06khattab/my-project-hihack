...
void setupLESENSE(void)
{
  ...
  static const LESENSE_ChDesc_TypeDef initLesenseCh6 =
  {
    .enaScanCh     = true,
    .enaPin        = true,
    .enaInt        = false,
  ...
  /* Configure channel 6 */
  LESENSE_ChannelConfig(&initLesenseCh6, LCSENSE_CH);
...
void setupPRS(void)
{
  ...
  /* LESENSE SCANRES bit 6 will be used as PRS signal */
  PRS_SourceAsyncSignalSet(PRS_CHANNEL, PRS_CH_CTRL_SOURCESEL_LESENSEL, PRS_CH_CTRL_SIGSEL_LESENSESCANRES6);
}
